...
(defun read-and-cache-projects ()
  ...
  (with-open-file (s "~/src/lisp/slugelisp/projects.txt")
...
(defun cache-load (name type)
  ...
  (let ((file-name (format nil "~~/src/lisp/slugelisp/cache/~a/~a" type name)))
